...
e?n("#js-hp__banner").css("background-image",'url("//'+window.location.hostname+"/content/themes/inchoo/4/images/inchoo/-homepage-images/inchoo/-"+t+'.webp")'):n("#js-hp__banner").css("background-image",'url("//'+window.location.hostname+"/content/themes/inchoo/4/images/inchoo/-homepage-images/inchoo/-"+t+'.jpg")')}),o.prototype.hideBlocks=function(){
